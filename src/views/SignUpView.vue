  ...
  <div class="login-view">
    <div class="login-box">
      <form class="login-form" @submit.prevent="login">
        <h3 class="h3">Реєстрація</h3>
        <h6 class="h6">Маєте акаунт? <RouterLink class="sign-up-link" to="/login">Вхід</RouterLink></h6>
        <div class="input-box">
        ...
        <button class="login-btn" type="submit">Зареєструватися</button>
